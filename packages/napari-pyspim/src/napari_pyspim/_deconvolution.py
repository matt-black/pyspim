...
class DeconvolutionWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.psf_a_fwhm_lateral.setValue(2.345)
        ...
        self.psf_a_fwhm_axial.setValue(12.923)
        ...
        self.psf_b_fwhm_lateral.setValue(2.345)
        ...
        self.psf_b_fwhm_axial.setValue(12.923)
        ...
        self.bp_a_fwhm_lateral.setValue(2.345)
        ...
        self.bp_a_fwhm_axial.setValue(12.923)
        ...
        self.bp_b_fwhm_lateral.setValue(2.345)
        ...
        self.bp_b_fwhm_axial.setValue(12.923)
