...
class DeconvolutionWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.psf_a_fwhm_lateral.setValue(2.000)
        ...
        self.psf_a_fwhm_axial.setValue(10.304)
        ...
        self.psf_b_fwhm_lateral.setValue(2.000)
        ...
        self.psf_b_fwhm_axial.setValue(10.304)
