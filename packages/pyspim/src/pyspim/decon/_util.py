...
from ..typing import BBox3D, NDArray, SliceWindow
...
def crop_and_pad_for_deconv(vol: NDArray, bbox: Optional[BBox3D], pad: int) -> NDArray:
...
def _crop_bounds_and_padding(
    vol: NDArray, bbox: BBox3D, pad: int
...
def _crop_and_pad(vol: NDArray, padl: __tup3, padr: __tup3, lowb: __tup3, uppb: __tup3):
...
def initialize_estimate(
    a: cupy.ndarray, b: cupy.ndarray, order: str = "F"
) -> cupy.ndarray:
